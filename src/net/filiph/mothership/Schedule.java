...
public class Schedule {
	...
	public static final Message[] messages = {
        ...
        new Message(date(2013, 04, 15,  0, 35), "Bylo v notifikaci napsáno Eddie??", true, false, false, 1),
        new Message(date(2013, 04, 15,  1, 50), "Ti troubové zase pořádají <a href='http://pardubice.devfest.cz'>DevFest</a>, naštěstí jsem tu já...", true, false, false, 1),
        new Message(date(2013, 04, 15,  2,  0), "Spíš? Message from code...", true, false, false, 1),
	};
